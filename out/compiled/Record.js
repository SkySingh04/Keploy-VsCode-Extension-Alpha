	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(a, "class", "homebutton svelte-1f3i7v1");
				add_location(a, file, 25, 4, 965);
				attr_dev(button0, "id", "selectRecordFolderButton");
				attr_dev(button0, "class", "secondary svelte-1f3i7v1");
				...
				attr_dev(input1, "class", "svelte-1f3i7v1");
				add_location(input1, file, 42, 4, 1441);
				attr_dev(div1, "id", "appCommandDiv");
				attr_dev(div1, "class", "svelte-1f3i7v1");
				...
				attr_dev(select0, "class", "svelte-1f3i7v1");

	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(a, "class", "homebutton svelte-16buzzd");
				add_location(a, file, 27, 4, 1062);
				attr_dev(button0, "id", "selectRecordFolderButton");
				attr_dev(button0, "class", "secondary svelte-16buzzd");
				add_location(button0, file, 30, 4, 1155);
				...
				attr_dev(input0, "class", "svelte-16buzzd");
				add_location(input0, file, 33, 4, 1258);
				attr_dev(div0, "id", "selectFolderDiv");
				attr_dev(div0, "class", "svelte-16buzzd");
				add_location(div0, file, 29, 2, 1124);
				attr_dev(button1, "id", "enterAppCommandButton");
				button1.disabled = "true";
				attr_dev(button1, "class", "secondary svelte-16buzzd");
				add_location(button1, file, 41, 4, 1426);
				attr_dev(input1, "type", "text");
				attr_dev(input1, "id", "recordCommand");
				attr_dev(input1, "name", "recordCommand");
				attr_dev(input1, "placeholder", "Enter App Command");
				attr_dev(input1, "class", "svelte-16buzzd");
				add_location(input1, file, 44, 4, 1538);
				attr_dev(div1, "id", "appCommandDiv");
				attr_dev(div1, "class", "svelte-16buzzd");
				add_location(div1, file, 40, 2, 1397);
				option0.__value = "manual";
				set_input_value(option0, option0.__value);
				add_location(option0, file, 54, 8, 1752);
				option1.__value = "record";
				set_input_value(option1, option1.__value);
				add_location(option1, file, 55, 8, 1799);
				attr_dev(select0, "id", "selectflags");
				attr_dev(select0, "class", "svelte-16buzzd");
				add_location(select0, file, 53, 6, 1718);
				attr_dev(div2, "id", "flags");
				add_location(div2, file, 52, 4, 1695);
				option2.__value = "manual";
				set_input_value(option2, option2.__value);
				add_location(option2, file, 60, 8, 1934);
				option3.__value = "record";
				set_input_value(option3, option3.__value);
				add_location(option3, file, 61, 8, 1979);
				attr_dev(select1, "id", "selectflagValue");
				attr_dev(select1, "class", "svelte-16buzzd");
				add_location(select1, file, 59, 6, 1896);
				attr_dev(div3, "id", "flagValue");
				add_location(div3, file, 58, 4, 1869);
				attr_dev(div4, "id", "flagsDiv");
				attr_dev(div4, "class", "svelte-16buzzd");
				add_location(div4, file, 51, 2, 1671);
				attr_dev(button2, "id", "startRecordingButton");
				button2.disabled = "true";
				attr_dev(button2, "class", "svelte-16buzzd");
				add_location(button2, file, 65, 2, 2055);
				attr_dev(hr, "class", "svelte-16buzzd");
				add_location(hr, file, 67, 2, 2135);
				attr_dev(img, "class", "keploylogo svelte-16buzzd");
				...
				add_location(img, file, 70, 6, 2201);
				add_location(h30, file, 75, 6, 2347);
				attr_dev(div5, "id", "upperOutputDiv");
				attr_dev(div5, "class", "svelte-16buzzd");
				add_location(div5, file, 69, 4, 2169);
				attr_dev(h1, "id", "generatedRecordCommand");
				attr_dev(h1, "class", "svelte-16buzzd");
				add_location(h1, file, 78, 6, 2413);
				attr_dev(div6, "id", "recordCommandDiv");
				add_location(div6, file, 77, 4, 2379);
				attr_dev(button3, "id", "stopRecordingButton");
				attr_dev(button3, "class", "svelte-16buzzd");
				add_location(button3, file, 80, 4, 2485);
				attr_dev(h31, "id", "recordStatus");
				attr_dev(h31, "class", "svelte-16buzzd");
				add_location(h31, file, 81, 4, 2546);
				attr_dev(div7, "id", "recordedTestCases");
				attr_dev(div7, "class", "svelte-16buzzd");
				add_location(div7, file, 82, 4, 2579);
				attr_dev(div8, "id", "outputDiv");
				add_location(div8, file, 68, 2, 2144);
				add_location(body, file, 26, 0, 1051);
			},

	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				button3.textContent = "Start Recording";
				t15 = space();
				hr = element("hr");
				t16 = space();
				div8 = element("div");
				...
				attr_dev(button0, "class", "secondary svelte-3q15g6");
				add_location(button0, file, 27, 4, 1062);
				attr_dev(button1, "id", "selectRecordFolderButton");
				attr_dev(button1, "class", "secondary svelte-3q15g6");
				add_location(button1, file, 30, 4, 1164);
				...
				attr_dev(input0, "class", "svelte-3q15g6");
				add_location(input0, file, 33, 4, 1267);
				attr_dev(div0, "id", "selectFolderDiv");
				attr_dev(div0, "class", "svelte-3q15g6");
				add_location(div0, file, 29, 2, 1133);
				attr_dev(button2, "id", "enterAppCommandButton");
				button2.disabled = "true";
				attr_dev(button2, "class", "secondary svelte-3q15g6");
				add_location(button2, file, 41, 4, 1435);
				attr_dev(input1, "type", "text");
				attr_dev(input1, "id", "recordCommand");
				attr_dev(input1, "name", "recordCommand");
				attr_dev(input1, "placeholder", "Enter App Command");
				attr_dev(input1, "class", "svelte-3q15g6");
				add_location(input1, file, 44, 4, 1547);
				attr_dev(div1, "id", "appCommandDiv");
				attr_dev(div1, "class", "svelte-3q15g6");
				add_location(div1, file, 40, 2, 1406);
				option0.__value = "manual";
				set_input_value(option0, option0.__value);
				add_location(option0, file, 54, 8, 1761);
				option1.__value = "record";
				set_input_value(option1, option1.__value);
				add_location(option1, file, 55, 8, 1808);
				attr_dev(select0, "id", "selectflags");
				attr_dev(select0, "class", "svelte-3q15g6");
				add_location(select0, file, 53, 6, 1727);
				attr_dev(div2, "id", "flags");
				add_location(div2, file, 52, 4, 1704);
				option2.__value = "manual";
				set_input_value(option2, option2.__value);
				add_location(option2, file, 60, 8, 1943);
				option3.__value = "record";
				set_input_value(option3, option3.__value);
				add_location(option3, file, 61, 8, 1988);
				attr_dev(select1, "id", "selectflagValue");
				attr_dev(select1, "class", "svelte-3q15g6");
				add_location(select1, file, 59, 6, 1905);
				attr_dev(div3, "id", "flagValue");
				add_location(div3, file, 58, 4, 1878);
				attr_dev(div4, "id", "flagsDiv");
				attr_dev(div4, "class", "svelte-3q15g6");
				add_location(div4, file, 51, 2, 1680);
				attr_dev(button3, "id", "startRecordingButton");
				button3.disabled = "true";
				attr_dev(button3, "class", "svelte-3q15g6");
				add_location(button3, file, 65, 2, 2064);
				attr_dev(hr, "class", "svelte-3q15g6");
				add_location(hr, file, 67, 2, 2144);
				attr_dev(img, "class", "keploylogo svelte-3q15g6");
				...
				add_location(img, file, 70, 6, 2210);
				add_location(h3, file, 75, 6, 2356);
				attr_dev(div5, "id", "upperOutputDiv");
				attr_dev(div5, "class", "svelte-3q15g6");
				add_location(div5, file, 69, 4, 2178);
				attr_dev(h1, "id", "generatedRecordCommand");
				attr_dev(h1, "class", "svelte-3q15g6");
				add_location(h1, file, 78, 6, 2422);
				attr_dev(div6, "id", "recordCommandDiv");
				add_location(div6, file, 77, 4, 2388);
				attr_dev(button4, "id", "stopRecordingButton");
				attr_dev(button4, "class", "svelte-3q15g6");
				add_location(button4, file, 80, 4, 2494);
				attr_dev(div7, "id", "recordedTestCases");
				add_location(div7, file, 81, 4, 2555);
				attr_dev(div8, "id", "outputDiv");
				add_location(div8, file, 68, 2, 2153);

	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(img, "class", "svelte-vcpp5u");
				add_location(img, file, 34, 4, 595);
				add_location(h2, file, 36, 6, 735);
				attr_dev(div0, "id", "lastTestResults");
				attr_dev(div0, "class", "svelte-vcpp5u");
				add_location(div0, file, 37, 6, 768);
				attr_dev(div1, "class", "lastTestResultsContainer");
				add_location(div1, file, 35, 4, 690);
				attr_dev(div2, "id", "topGrid");
				attr_dev(div2, "class", "svelte-vcpp5u");
				add_location(div2, file, 33, 2, 572);
				attr_dev(hr, "class", "svelte-vcpp5u");
				add_location(hr, file, 40, 2, 853);
				attr_dev(button0, "id", "recordButton");
				add_location(button0, file, 42, 4, 888);
				attr_dev(button1, "id", "testButton");
				add_location(button1, file, 43, 2, 943);
				attr_dev(button2, "id", "runCustomCommandButton");
				button2.disabled = "true";
				add_location(button2, file, 44, 2, 993);
				attr_dev(div3, "id", "buttonsDiv");
				attr_dev(div3, "class", "svelte-vcpp5u");
				add_location(div3, file, 41, 2, 862);
				add_location(body, file, 32, 0, 563);
			},

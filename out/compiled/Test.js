	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(a, "class", "homebutton svelte-8elkzz");
				add_location(a, file, 24, 0, 1017);
				attr_dev(button0, "id", "selectTestFolderButton");
				attr_dev(button0, "class", "secondary svelte-8elkzz");
				...
				attr_dev(input1, "class", "svelte-8elkzz");
				add_location(input1, file, 42, 4, 1498);
				attr_dev(div1, "id", "appCommandDiv");
				attr_dev(div1, "class", "svelte-8elkzz");
				...
				attr_dev(select0, "class", "svelte-8elkzz");
				...
				attr_dev(select2, "class", "svelte-8elkzz");
				add_location(select2, file, 63, 2, 2011);
				attr_dev(button2, "id", "startTestingButton");
				button2.disabled = "true";
				attr_dev(button2, "class", "svelte-8elkzz");
				add_location(button2, file, 68, 2, 2229);
				attr_dev(hr, "class", "svelte-8elkzz");
				add_location(hr, file, 69, 2, 2302);
				attr_dev(img, "class", "keploylogo svelte-8elkzz");

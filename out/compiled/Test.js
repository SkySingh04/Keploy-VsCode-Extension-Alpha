	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(a, "class", "homebutton svelte-kc9chf");
				...
				attr_dev(button2, "class", "svelte-kc9chf");
				...
				add_location(h3, file, 77, 6, 2514);
				...
				add_location(button3, file, 82, 4, 2646);
				attr_dev(div7, "id", "testResults");
				attr_dev(div7, "class", "svelte-kc9chf");
				add_location(div7, file, 83, 4, 2703);
				attr_dev(div8, "id", "outputDiv");
				add_location(div8, file, 70, 2, 2311);
